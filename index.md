<html style="--vh:8.36px;"><head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="twitter:card" value="summary">
    <meta name="twitter:title" value="Story Trails" id="twitter-title">
    ...
    <link rel="icon" type="image/png" href="https://lh5.googleusercontent.com/oDsO5-8r2sx-2iSTmjUJaQwMehxEyOPeZH9MmExAd_wmTCJa4At1cRGlFapd-BTDOcOe7FGEeQ0CEX0enjDatnbT49v-dHwpmb6JScDFVqVnpjrodgebRk3NR3WV3iqJLA=w1280">
    <title>Story Trails</title>
    <script id="data" type="text/json">{"cards":[{"cell":[0,0],"text":"The Hunger Games\nA Story Trail \n〰〰〰〰🏹〰〰〰〰","type":"heading","icons":[]},{"cell":[1,0],"text":"Chapter 3 🚝\n\nKatniss and Peeta are taken away to the Justice building, where they are allowed some guests.  Katniss tries to figure out a way for her family to still have food while she is gone, and while she will likely be gone forever.  After her time is up, Katniss and Peeta are taken onto the Tribute Train to the Capitol, where they are presented with massive feasts.  They watch the televised recordings of the other Reapings, and take note of some of their enemies.  Haymitch, their mentor for the games, and a previous winner, arrives, but he is very drunk, and mostly unintelligible.  ","type":"basic-red","icons":[]},{"cell":[-1,1],"text":"Chapters 1-2 🛖\n\nKatniss Everdeen lives in Panem, a dystopian remnant of North America.  In particular she lives in District 12, a coal mining district in what used to be Appalachia.  Due to a lack of food, Katniss is an experienced hunter, and regularly, though illegally, hunts in the woods.  Every year, to demonstrate their power, the Capitol of Panem orchestrates the Hunger Games, which is a fight to the death, using two tributes from each District.  The lottery for this “honour” called the Reaping, occurs, and everyone attends.  Katniss’s younger sister Prim is chosen, and Katniss, feeling that her sister can not go through the games, volunteers.  The other tribute is the Baker’s son, Peeta Mellark, who Katniss feels saved her life when he gave her bread as she starved to death years ago.  ","type":"basic-red","icons":[]},{"cell":[-1,2],"text":"Chapter 4 🌃\n\nThe train continues, and Katniss recounts her memory of how she learned to hunt, but singles out on the fact that she could only do it because of Peeta’s bread, making it hard for her to accept the fact that she must soon kill him.  Haymitch arrives, more sober this time, but still fairly drunk, and he laughs off their requests for help.  Only after Katniss and Peeta both attack Haymitch does he recognize that they may be able to fight, and he agrees to help them out.  The train arrives in the Capitol, where crowds mass, excited to watch the tributes die.  ","type":"basic-red","icons":[]},{"cell":[0,1],"text":"Chapter 5 🔥\n\nKatniss is quickly attended to by stylists, who must work to make an impression for the opening ceremony, where they will roll down the streets of the capitol.  They work to clean her of longstanding filth, which has remained due to the horrible conditions in District 12.  The head designer arrives after the stylists have finished their work, and allows the tributes to eat.  After they have finished, he announces that he will effectively set both Peeta and Katniss on fire, as that ties into a required coal theme of the district, and makes a sizable impression.  Luckily for both of them, the fire is fake, and does not burn with heat.  They stand in their chariots, and as one last touch, the designer asks that they appear as a team.  The outfits are an instant success, and the Hunger Games start off well.","type":"basic-red","icons":[]},{"cell":[1,1],"text":"Chapter 6 🚁\n\nThe Tributes arrive in the training center.  They eat, and plan their strategies.  A servant arrives, that Katniss feels she knows.  Peeta and Katniss go up onto the roof, and Katniss remembers that the servant was a traitor who she saw running in the woods one day, until she was picked up by a hovercraft and transported to the Capitol to work as a slave.  Peeta and Katniss return, and finish plotting their strategies in secret, while Katniss wonders if the servant she forgot to help will enjoy Katniss’s impending death.","type":"basic-red","icons":[]},{"cell":[-2,3],"text":"Chapter 7 🍎\n\nKatniss and Peeta begin their training.  Peeta excels at camouflage, and Katniss learns several new skills such as some snares.  They train for several days, but the gamemakers mostly ignore them.  When the time comes for them to perform in front of the gamemakers, on the assessment, Katniss prepares to show off her shooting.  When she arrives, most of the gamemakers are focused on the food that is set for them.  Katniss uses the bow a few times, it is too tight, and she has to change her methods slightly to get used to it.  She shoots several perfect shots, but almost no-one notices.  In a fit of rage, Katniss shoots the apple out of their roast pig’s mouth, and pins it to the wall, stalking off to the elevator.","type":"basic-red","icons":[]},{"cell":[-1,3],"text":"Chapter 8 🏅\n\nKatniss almost instantly feels regret about what she did.  The Gamemakers likely wouldn’t take well to being attacked, and she would likely be punished by getting an extremely low score.  Just before the scores are televised, Katniss reveals what she did to Haymitch and the others.  They are shocked, but realize that nothing can be done with it.  The scores come up for Katniss, an 11 out of 12.  The best score out of them all.  Katniss is shocked, but understands that they likely felt she could put on the best show.  Peeta reveals that he wishes to be trained alone from now on, surprising Katniss.","type":"basic-red","icons":[]},{"cell":[0,2],"text":"Chapter 9 🎙️\n\nKatniss feels at first betrayed, but later relieved that she doesn’t have to pretend to be Peeta’s friend anymore.  Katniss begins to prepare for the interviews, and is taught the proper style and manners of the Capitol, having to learn to walk in high heels, and smile more.  Haymitch has her practice for the interviews, but Katniss can’t come across any better than hostile.  She is given an interview dress designed by her stylists, involving cloth flames instead this time, and waits for the interview.  The other tributes are interviewed, each trying to appear a certain way.  When Katniss is called, she does her interview, doing better than expected.  However, when Peeta comes up, he makes a startling remark.  He is in love with Katniss.","type":"basic-red","icons":[]},{"cell":[1,2],"text":"Chapter 10 🏁\n\nKatniss is furious about Peeta’s confession, viewing it to be a lie to generate support.  She attacks Peeta when they meet again in the Training Center, only being calmed down when Haymitch tells of how it might have helped her.  Katniss struggles to sleep, and goes up onto the roof, where Peeta is already there.  Peeta tells about how he wishes to die as himself, and not someone changed by the games.  However, Katniss is still angry about his interview, and doesn’t really care.  As the games approach, Katniss is given her outfit and is sent in a hovercraft to the starting location.","type":"basic-red","icons":[]},{"cell":[-2,4],"text":"Chapters 12 and 13 🌳\n\nShocked by the revelation that Peeta is working with the Careers, Katniss almost reveals herself.  However, the Careers leave, and Katniss is able to escape.  But so far, Katniss has been unable to find water, and is slowly dying of dehydration.  She continues, wondering why Haymtich can’t send her a water bottle, before realizing that he likely doesn’t want to, and that water must be nearby.  She stumbles upon a pond, almost without realizing it, and refills her water supply.  But the Gamemakers have decided that the proceeds are too boring, and send in a massive forest fire.  Katniss struggles to outrun the flames, and when she finally feels somewhat safe, fireballs begin shooting at her from cannons hidden in the woods.  Katniss is badly burned, but is eventually able to make it out of the reach of the flames, though the smoke still fills the air.  She luckily finds another pond, and treats her devastating burns in it, though it is of little use.  After a few hours, the Careers arrive, and Katniss just makes it into a tree, where she appears safe for now.  None of them can climb.  But as night falls, Katniss sees another tribute in the trees, Rue.","type":"basic-blue","icons":[]},{"cell":[-1,4],"text":"Chapter 14 🐝\n\nRue points to a nest of genetically engineered wasps, Tracker Jackers, who hunt down prey, and whose stings cause hallucinations.  Katniss is now trapped between the nest, and the Careers below.  She decides to try and kill two birds with one stone, and as soon as the anthem begins, and drowns out the noise, she begins sawing at the branch holding the nest.  But the anthem ends, and the sawing hasn’t been completed.  Katniss returns to her sleeping bag, and  falls asleep.  In the early morning, all the Careers have fallen asleep, but Katniss has woken up.  She continues sawing off the branch, and when she finishes, throws it off the tree.  It lands directly in the Career’s campsite, and two tributes fall almost instantly.  Even though she is now very confused due to the few wasps finding her, Katniss struggles down to grab the bow and arrows left by the Careers.  After she grabs them, she sits for a moment too long, and Cato comes through the brush chasing Peeta, who yells at Katniss to run.","type":"basic-green","icons":[]},{"cell":[2,1],"text":"Chapter 11 🎒\n\nThe Tributes are placed on circles surrounding a large Cornucopia filled with special supplies.  Katniss was advised by Haymitch not to enter into the fray, but she sees a perfect bow and arrow, and decides to try it.  Peeta makes eye contact with Katniss and is able to distract her long enough that when they are allowed to go, she waits too long and has to settle for a backpack instead.  She rushes into the woods, and runs for several hours.  When she finally reaches a place she can stop, she finds that her backpack has no water, and she will have to find that.  As night falls, she finds a tree, and sets up camp in it.  Late at night, she wakes up to the sound of another tribute starting a fire, an extremely stupid decision considering the Careers who are out hunting.  The Careers soon arrive, and kill the tribute who built the fire, while ignoring Katniss.  But one of the voices mixed in with the Careers is the voice of Peeta.","type":"basic-green","icons":[]},{"cell":[0,3],"text":"Chapter 15 🤝\n\nKatniss slowly comes out of the Tracker Jacker Poison, though her hallucinations seem to last for days.  When she finally comes to, her whole body is stiff, and she struggles to move.  As Katniss is badly dehydrated, she decides to start looking for water.  On the way, she tries out her bow and arrow, and is able to kill a rabbit.  When she reaches the stream, she stocks up on water, and treats her numerous injuries, and then proceeds to head upstream.  Rue appears, and Katniss asks if she wants to join an alliance.  Rue accepts, and produces some leaves to cure Katniss’s stings, while Katniss procures food.  They talk about each of their districts, and Rue reveals that a pair of faulty sunglasses Katniss got were actually night vision glasses.  When night falls, Katniss and Rue decide to do something about the Career’s current power.","type":"basic-red","icons":[]},{"cell":[1,3],"text":"Chapter 16 💥\n\nKatniss and Rue decide to destroy the Careers’ supplies.  Rue is to set three campfires, and draw the Careers away, while Katniss figures out how to destroy their supplies.  They gather the wood, and set out.  Katniss reaches the Career’s campsite earlier than expected, and waits for Rue to draw out the Careers, who are still recovering from the tracker jacker attack.  The supplies are set up in a pyramid, a fair distance away from the camp, and completely out in the open.  Katniss figures it must be rigged somehow, and that the whole thing is a trap.  Soon, the Careers see Rue’s fire, and head out to kill what they think is Katniss.  Katniss watches the pyramid for a short while, and then, just as she is about to step out, Foxface, the small sly tribute, arrives.  Foxface navigates through the ground in strange little hops, and appears fearful when she lands just outside one of her invisible squares.  Katniss realizes that the whole thing is mined, and that the supplies are protected by landmines that would explode upon contact.  Katniss spots a bag of apples, and shoots at the cord, releasing the apples, which fall and set off the explosives.","type":"basic-blue","icons":[]},{"cell":[2,2],"text":"Chapter 17 🕸️\n\nKatniss successfully blows up the Careers’ supplies, injuring herself in the process.  When she is able to crawl into the woods, the Careers return, devastated by their loss.  The boy from District Three, who built the setup, is swiftly killed.  In the morning, the careers set out hunting for Katniss, who they do not realize is right next to them.  Katniss decides to move out, and find Rue.  When she reaches the location of their meeting spot, Rue has not arrived.  Katniss waits in a tree, but when several hours pass, she goes out looking for Rue.  As she makes her way through the woods, she hears a scream, and finds Rue trapped in a net, and the boy from District One approaching.","type":"basic-red","icons":[]},{"cell":[-3,6],"text":"Chapter 18 🪦\n\nRue is murdered by the boy from District One.  Katniss kills the boy with one shot from her bow.  Katniss then sings to Rue, on her request, until she finally dies.  In an attempt to stand up to the Capitol, and to oppose their games, Katniss decorates Rue with flowers, in a sort of protest to the bloodbath that is the games.  Once Rue is taken up by the hovercraft, Katniss wanders the woods, until night begins to fall, at which she finds a suitable tree and prepares to sleep.  But a parachute carrying a gift arrives, holding bread from District 11, in a form of thank you to Katniss.  In the morning, Katniss feels a deep despondency, and she struggles to accomplish simple tasks.  She tries to draw in the careers by lighting a fire, but it is of no use.  When night falls again, a special announcement is made.  There may now be two winners of the games, provided they come from the same district.","type":"basic-green","icons":[]},{"cell":[-2,5],"text":"Chapter 19 🤕\n\nKatniss decides to seek out Peeta, in an attempt to see if they can both win the games.  Reasoning that he must be near water, she combs the stream for him.  Eventually, she finds him, perfectly camouflaged against the stream bank.  He is near death, and even as Katniss attempts to clean him off, he is unable to move.  To heal him, Katniss applies the special leaves she was given by Rue, and she slowly draws out the blood and pus from the wound inflicted upon him by Cato.  As night falls, Katniss attempts to get Peeta to move downstream, where they will be safer from attack.  He struggles to walk, and they barely make it downstream.  However they are able to find a cave in the rocks where Peeta can rest, and Katniss sits down to guard.","type":"basic-red","icons":[]},{"cell":[-1,5],"text":"Chapter 20 🧪\n\nPeeta’s condition worsens, and Katniss grows ever more tired, due to the little sleep she gets from having to keep guard.  They try to figure out what their plan should be, and wonder if Peeta will be able to last to the end.  After Peeta asks Katniss to tell a story, she tells the story of how Prim got a goat, which further illustrates her relationship with Prim.  An announcement is made, the gamemakers are preparing a feast, in which everyone will receive what they need.  Katniss anticipates that the medicine that they need will be at the feast, and attempts to go.  Peeta refuses to let her go, and threatens to kill himself.  While foraging that evening, Katniss receives a vial of sleeping medicine, and tricks Peeta into eating it in a jam, knocking him unconscious.  \t","type":"basic-red","icons":[]},{"cell":[0,4],"text":"Chapter 21 🪨\n\nKatniss prepares for the feast, gathering the necessary supplies.  She sets out at night, so as to get there early.  When she reaches the Cornucopia, Katniss waits for the feast to arrive.  As day breaks, the four backpacks rise up out of holes in the ground, and before anyone can react, Foxface grabs her backpack, and rushes off to the woods.  Katniss rushes to grab her backpack, deflecting a knife thrown by Clove, the other tribute from District 2.  As Katniss grabs her backpack with the medicine inside, Clove is able to get a knife in Katniss’ forehead.  Soon, Clove has tackled Katniss, and begins slowly killing her.  However, Thresh grabs Clove, and kills her with a rock, turning on Katniss after.  Katniss tells Thresh about Rue, and Thresh agrees to spare her.  Katniss rushes back to Peeta with the backpack, gives Peeta the medicine, and blacks out.","type":"basic-red","icons":[]},{"cell":[1,4],"text":"Chapters 22 and 23 🫐\n\nKatniss wakes up from her unconscious state.  Peeta has been healed, though his leg is still lame.  Katniss tells Peeta of how she got the medicine, including the part about Thresh sparing her.  It begins to rain, and it rains harder as the day progresses, an attempt by the gamemakers to push Cato and Thresh to fighting.  Katniss and Peeta begin to run out of food, and neither of them can hunt, due to Peeta’s inability, and Katniss’s injury.  Katniss decides to see if she can play up the romance, and get more food from Haymitch, reasoning that it will make a better show for the Capitol.  Luckily, she is correct, and Haymitch sends a small feast, which they ration out.  While they wait away the day, they learn that Thresh has died, and they resolve to set out hunting, and to potentially kill Cato.  Peeta is much too loud, and so Katniss sends him off to gather plants.  After a while, Peeta has not checked in with Katniss, so she tries to find him, and notices that he has suspicious berries.  A cannon goes off, and Foxface, who has been tracking them, is dead.  Peeta had gathered poisonous berries, and Foxface ate them.  ","type":"basic-blue","icons":[]}]}</script>
  ...
  <body class="no-select" onload="loaded()">
    <div id="templates" hidden="">
      ...
      <div class="card-edit-bar icon-bar" id="cardbar-template" data-locked-visibility="hidden" hidden="">
        <button id="edit-card" title="edit this card">📝</button>
        <button id="link-card" hidden="" title="link this card" draggable="true">🔗</button>
      </div>
    </div>
    <div id="pan-screen">
      <main id="scene" data-export-clear="" class="" style="transform: scale(1) translate(0px, 0px);"></main>
    </div>
    <div id="coords" draggable="true">#0,0</div>
    <div class="icon-bar" id="toolbar" data-block-clicks="">
      <div id="open-about" title="information &amp; settings">🔨</div>
      <div id="zoom" title="switch zoom level">🔎</div>
      <div id="center" title="jump to center">🏠</div>
      <div id="add-delete-icon" draggable="true" title="drag a new card from here or a drop an unwanted card" data-locked-visibility="hidden" hidden="">🗃️</div>
      <div id="fullscreen" title="toggle fullscreen" hidden="">💢</div>
      <div id="unlocked" title="prevent accidental editing" data-locked-visibility="hidden" hidden="">🔓</div>
      <div id="locked" title="enable editing" data-locked-visibility="shown">🔒</div>
    </div>
    ...
    <div class="screen" id="editor-screen" data-click-to-hide="" hidden="">
      ...
      <div id="editor-section" data-block-clicks="">
        <div class="tab-bar">
          <div data-close-parent-screen="">◀ </div>
          <div class="" data-tab="text" data-tab-set="card">TEXT</div>
          <div data-tab="icons" data-tab-set="card" class="">ICONS</div>
          <div data-tab="style" data-tab-set="card" class="selected">STYLE</div>
        </div>
        <div class="editor-page tab-page" data-page="text" data-tab-set="card" hidden="">
        ...
        <div class="editor-page" data-page="style" data-tab-set="card">
          ...
          <div class="button-list">
            ...
            <input id="upload-image-input" type="file" accept="image/*" hidden="">
          </div>
        </div>
      </div>
    </div>
...
arrangement of cards that together might form an essay or a mind map or a story trail apparently.</p>
<p>click and drag to navigate the board. double click a card to jump to it. All my cards have cool emojis too, because I needed some pictures.</p>
<p>This page is also a working copy of domino. Toggle into unlocked mode with
the 🔓 icon on the toolbar, and make it better so that you can send it to me to explain my low grade!</p>
...
<td>make copy of card</td>
        ...
        <div class="tab-page" data-page="about" data-tab-set="menu" hidden="">
          <div id="version">
            version—beta-7 (11/5/2020)</div><h2>about domino</h2>
<p>The developer guy would like to talk about this, so if you want to use it here is what he says: domino is a tool for collaging fragmented thoughts into a larger idea.
...
<p><strong>sg</strong> for <a href="https://zenzoa.itch.io/mosi">môsi</a> whose source code was a valuable reference for developing
web tools. also for feedback and bug reports.</p>
<p><strong>Kris De Decker</strong> for <a href="https://solar.lowtechmagazine.com/">LOW←TECH MAGAZINE</a> which continues to inspire me to
